...
public class NoAlcoholicCocktailsFragment extends Fragment implements CocktailDetailsAction, DetailsCallBack {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvCocktails.setLayoutManager(gridLayoutManager);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        cocktailsViewModel.getAllNoneAlcoholicCocktails().observe(getViewLifecycleOwner(), cocktails -> {
            rvAdapter = new CocktailsRecyclerViewAdapter(getContext(), cocktails, NoAlcoholicCocktailsFragment.this);
    ...
    public void detailsFetched(CocktailDetails cocktailDetails) {
        ...
        NavHostFragment.findNavController(NoAlcoholicCocktailsFragment.this).navigate(R.id.action_nav_noAlcoholic_to_detailsFragment);
